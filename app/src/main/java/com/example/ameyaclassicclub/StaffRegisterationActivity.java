                            ...
                            (new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        MemberRegisterationModel data = new MemberRegisterationModel(stafffirstName,staffuserName,staffmobile,staffemail,staffDesignation,gender,memberOrStaff,null);
