...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("MemberOrStaff"+memberOrStaff);
...
//        if(memberOrStaff.equals("member")) {
            Intent intent = new Intent(getApplicationContext(), MemberRegisterationActivity.class);
            intent.putExtra(ProjectConstants.MEMBER_OR_STAFF,"member");
            startActivity(intent);
//        }
//        else{
//            Intent intent = new Intent(getApplicationContext(), StaffRegisterationActivity.class);
